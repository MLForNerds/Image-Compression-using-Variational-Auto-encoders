...
def parse_args():
    ...
    parser.add_argument("--chkfile", "-c", default="checkpoints/videocompressor8192.chk",
                        help="Checkpointing file\n"
                             "Default=`checkpoints/videocomp.chk`")

    parser.add_argument("--pklfile", "-p", default="checkpoints/videocompressor8192.pkl",
    ...
    parser.add_argument("--input", "-i", default="vimeo_septuplet/sequences/",
                        help="Directory where training data lie. The structure of the directory should be like:\n"
                             "vimeo_septuplet/sequences/00003/\n"
                             "...............................\n"
    ...
    parser.add_argument("--lamda", "-l", type=int, default=8192,
